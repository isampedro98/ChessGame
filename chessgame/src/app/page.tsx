			...
			<main className="mx-auto flex w-full max-w-6xl flex-col gap-12">
				<header className="space-y-3">
					...
					<h1 className="text-3xl font-semibold">
						Motor de ajedrez + escena Three.js
					</h1>
					<p className="max-w-3xl text-slate-400">
						El dominio se modela con clases puras en TypeScript para que los
						movimientos, el estado de la partida y las reglas del juego sean
						independientes del render. A la derecha dejamos un placeholder para
						inyectar la escena WebGL.
					</p>
				</header>
				...
				<section className="grid gap-12 lg:grid-cols-[minmax(0,420px)_1fr]">
					<div className="space-y-4">
						...
						<p className="text-sm text-slate-500">
							Renderizamos la cuadrilla directamente desde el modelo para
							depurar reglas y servir de base a la escena 3D.
						</p>
					</div>
